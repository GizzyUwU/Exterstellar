...
3. Download the latest version from the [workflow](https://github.com/SabioOfficial/Team-Exterstellar/Exterstellar/actions/workflows/build-extension-zip.yml).
...
2. Download the latest version from the [workflow](https://github.com/SabioOfficial/Team-Exterstellar/Exterstellar/actions/workflows/build-extension-zip.yml).
4. Unzip it once.
