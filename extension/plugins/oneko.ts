...
Exterstellar.register({
    id: "oneko",
    name: "Oneko",
    description: "Plugin that brings the ever so popular kitty-that-follows-your-mouse-pointer to stardance!",
    author: "Gizzy",
    start() {
        ...
        function setSprite(name: keyof typeof spriteSets, frame: number) {
            ...
            nekoEl.addEventListener('selectstart', e => e.preventDefault());
            nekoEl.addEventListener('mousedown', e => e.preventDefault());
        }
